...
public class BoardControllerTest extends CommonTest {
	...
	void saveAndFindByIdTest() throws Exception {
		...
		mockMvc.perform(get(uri))
			...
			.andExpect(jsonPath("$.headerImage").value(headerImage));
	}
	...
	void updateTest() throws Exception {
		...
		mockMvc.perform(get(uri))
			...
			.andExpect(jsonPath("$.headerImage").value(updateHeaderImage))
			.andExpect(isUpdatedAtAfterCreatedAt("$.createdAt", "$.updatedAt"));
	}
